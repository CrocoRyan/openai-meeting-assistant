...
class MessageHandler:
    ...
    def start(self, chat_id):
        ...
        content_lines = [
            "Hi! Welcome to the meeting assistant bot! I'm here to help you with meeting summaries. Just provide me with the meeting audio, and I'll get started on transcripting & creating the summary for you. Below are some commands you can use:"]
    ...
    def transcript(self, chat_id):
        ...
        self.user_thread_state[chat_id].transcript = current_app.speech_service.recognize_speech_from_file(audio_path,
                                                                                                           language_code)
        current_app.ai_agent.respond(chat_id, self.user_thread_state[chat_id].thread_id,
                                     self.user_thread_state[chat_id].transcript + '\n Please summarize the speech')
